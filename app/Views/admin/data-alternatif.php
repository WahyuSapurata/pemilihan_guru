            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="alert" style="margin-top: 70px;" role="alert">
                        <h3 class="m-0"><i class="fas fa-server"></i> Alternatif</h3>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    foreach ($alternatif as $alt) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <form action="<?= base_url() ?>/admin/hapus_alternatif/<?= $alt['id_alternatif'] ?>" method="post">
                                                    <button type="button" class="badge badge-warning" style="border: none; margin-right: 10px;" data-toggle="modal" data-target="#edit_modal<?= $alt['id_alternatif'] ?>">
                                        ...
                                        <div class="modal fade" id="edit_modal<?= $alt['id_alternatif'] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="post" action="<?= base_url('admin/edit_alternatif/' . $alt['id_alternatif']) ?>">
                                                            <?= csrf_field(); ?>
