        ...
        <div class="content-wrapper" style="display: flow-root;">
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="alert text-left" style="margin-top: 70px;" role="alert">
                        <h3 class="m-0"><i class="fas fa-images"></i> Dokumentasi</h3>
                    </div>

                    <div class="card" style="margin-bottom: 70px;">
                        <div class="card-header">
                            <h5 class="card-title m-0">Tabel Data Dokumentasi</h5>
                        ...
                        <div class="card-body">
                            <table id="example2" class="table table-bordered table-hover text-center">
                                ...
                                <tbody>
                                    <?php $no = 1;
                                    foreach ($dokumentasi as $dks) { ?>
                                        <tr>
                                            <td><?= $no++ ?></td>
                                            <td><img src="<?= base_url('uploads/' . $dks['foto']) ?>" width="100" alt=""></td>
                                            <td>
                                                <form action="<?= base_url() ?>/admin/hapus_dokumentasi/<?= $dks['id_dokumentasi'] ?>" method="post">
                                                    <button type="button" class="badge badge-warning" style="border: none; margin-right: 10px;" data-toggle="modal" data-target="#edit_modal<?= $dks['id_dokumentasi'] ?>">
                                        ...
                                        <div class="modal fade" id="edit_modal<?= $dks['id_dokumentasi'] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST" enctype="multipart/form-data" action="<?= base_url('admin/edit_gambar/' . $dks['id_dokumentasi']) ?>">
                                                            <?= csrf_field(); ?>
                                                            <input type="hidden" name="lama" value="<?= $dks['foto'] ?>">
                                                            <div class="form-group">
                                                                <label>Gambar</label>
                                                                <input type="file" id="file_upload" class="custom" name="file_upload" onchange="previewimg()" required>
                                                            </div>
                                                            <img src="<?= base_url('uploads/' . $dks['foto']) ?>" width="100" alt="" class="mb-3 img-preview">
