                                ...
                                <tbody>
                                    ...
                                    foreach ($kriteria as $krt) : ?>
                                        <tr>
                                            ...
                                            <td><?= $krt['bobot'] ?></td>
                                            <td>
                                                <button type="button" class="badge badge-warning" style="border: none; margin-right: 10px;" data-toggle="modal" data-target="#edit_modal<?= $krt['id_kriteria'] ?>">
                                        ...
                                        <div class="modal fade" id="edit_modal<?= $krt['id_kriteria'] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="post" action="<?= base_url('admin/edit_kriteria/' . $krt['id_kriteria']) ?>">
                                                            <?= csrf_field(); ?>
                                                            <div class="form-group row">
                                                                <label>Kode</label>
                                                                <input type="text" class="form-control" name="kode" required="" id="kode" value="<?= $krt['kode']; ?>">
                                                            </div>
                                                            <div class="form-group row">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <select name="atribut" class="form-control" required>
                                                                    <option value="Benefit" <?= $krt['atribut'] == "Benefit" ? 'selected' : "" ?>>Benefit</option>
                                                                    <option value="Cost" <?= $krt['atribut'] == "Cost" ? 'selected' : "" ?>>Cost</option>
                                                                </select>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label>Bobot</label>
                                                                <input type="number" class="form-control" name="bobot" required="" id="bobot" value="<?= $krt['bobot']; ?>">
                                                            </div>
