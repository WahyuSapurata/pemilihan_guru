    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Ketua Yayasan</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('ketua/index') ?>" class="nav-link active">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row d-block text-center">
                                <h2>WEBSITE PEMILIHAN GURU TETAP <br> YAYASAN UNGGULAN ARIFAH</h2>
                            </div>
                        </div>
                    </div>
                    <!-- /.row -->
