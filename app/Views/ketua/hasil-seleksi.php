                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="<?= base_url('ketua/kriteria') ?>" class="nav-link">
                                ...
                                <li class="nav-item">
                                    <a href="<?= base_url('ketua/hasil') ?>" class="nav-link active">
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="alert" style="margin-top: 70px;" role="alert">
                        <h3 class="m-0"><i class="fas fa-vote-yea"></i> Hasil Seleksi</h3>
                    </div>

                    <div class="card" sty>
                        <div class="card-header">
                            <h5 class="card-title m-0">Nilai Alternatif</h5>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                    ...
                    <div class="card" sty>
                        <div class="card-header">
                            <h5 class="card-title m-0">Bobot</h5>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-hover text-center">
                                ...
                                <tbody>
                                    <tr>
                                        <?php foreach ($kriteria as $krt) : ?>
                                            <td><?= round($krt['bobot_kalkulasi'], 4) ?></td>
                                        <?php endforeach; ?>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <div class="card" sty>
                        <div class="card-header">
                            <h5 class="card-title m-0">Vector S</h5>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                    ...
                    <div class="card" style="margin-bottom: 70px;">
                        <div class="card-header">
                            <h5 class="card-title m-0">Vector V</h5>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
