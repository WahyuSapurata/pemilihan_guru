...
<body>
    ...
    <b:if cond='data:view.isError'>
        <div class='errorWrap'>
            ...
            <a class='homepage' title='Dzuhalah' href='<?= base_url('login_ketua/index') ?>'>Kembali Ke Login</a>
            <p style="margin-top: 10px;">&copy; Copyright <strong>YAYASAN PENDIDIKAN ARIFAH</strong>. All Rights Reserved</p>
        </div>
    </b:if>
